...
//' Compute Negative log-likelihood for HMM
 ...
 Type objective_function<Type>::operator() ()
 {
   ...
   PARAMETER_VECTOR(log_hs_local_obs); // local shrinkage parameters for obs
   PARAMETER_VECTOR(log_hs_global_obs); // global shrinkage parameters for obs
   PARAMETER_VECTOR(log_hs_local_hid); // local shrinkage parameters for hidden
   PARAMETER_VECTOR(log_hs_global_hid); // global shrinkage parameters for hidden
